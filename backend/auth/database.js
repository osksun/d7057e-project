	...
	return new Promise((resolve, reject) => {
		connection.connect((error) => {
			if(error) {
				...
				connection.query("CREATE TABLE IF NOT EXISTS users (id INT NOT NULL AUTO_INCREMENT, email VARCHAR(255) UNIQUE, password VARCHAR(255), PRIMARY KEY(id))", (error, result) => {
					if(error) {
